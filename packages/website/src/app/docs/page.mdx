...
1. **Install** the [browser extension](https://github.com/Neshat0/vibe-annotations-firefox/blob/main/packages/extension/FIREFOX.md) and optionally the [MCP server](https://www.npmjs.com/package/vibe-annotations-server).
...
- [MCP Setup](/docs/mcp-setup) — Connect your AI coding agent
