...
Vibe Annotations is licensed under the PolyForm Shield License. Subject to your compliance with these terms, you are granted a non-exclusive, worldwide, royalty-free license to use, copy, modify, and distribute the Software in accordance with the license terms.
...
Vibe Annotations facilitates integration with AI coding agents but:
...
- Agree your contributions will be licensed under the project license
...
- GitHub Issues: [github.com/Neshat0/vibe-annotations-firefox/issues](https://github.com/Neshat0/vibe-annotations-firefox/issues)
