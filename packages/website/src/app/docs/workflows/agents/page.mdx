...
[See demo video (upstream release)](https://github.com/RaphaelRegnier/vibe-annotations/releases/tag/v1.6.2)

## Compatible Agents

- **Claude Firefox extension** — has direct page access and can call the API from its JavaScript tool
...
The extension must be active on the page for the bridge API to be available. This works best when the agent uses **your browser** (Claude Firefox, DevTools MCP), since the extension is already installed.
